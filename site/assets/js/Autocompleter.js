/** For autocomple: using Harald Kirschner' s  Autocompleter */
...
Autocompleter.Base = new Class({
	...
	prefetch: function() {
		...
		if (this.element.value.length < this.options.minLength) { 
			this.hideChoices(); 
		} else if (this.element.value == this.queryValue) { 
			this.showChoices(); 
		} else  { 
			this.query();
		}
	...
	choiceSelect: function(el) {
		...
		this.observer.value = this.element.value = v;
		this.hideChoices();
